  ...
  return (
    <section
      ...
      style={{
        ...
        position: 'relative',
        background:
          'radial-gradient(circle at 80% 20%, rgba(0, 112, 243, 0.18) 0%, transparent 45%), radial-gradient(circle at 20% 80%, rgba(121, 40, 202, 0.18) 0%, transparent 45%), #040715',
        overflow: 'hidden',
      }}
    >
      ...
      <div className="container" style={{ position: 'relative', zIndex: 10 }}>
        <div className="section-title-wrap">
          <span className="badge-tag">LINE-UP DE DESTAQUE</span>
          <h2 style={{ textTransform: 'uppercase' }}>
            Aprenda com Quem Está{' '}
            <span style={{ color: '#00d2ff' }}>Construindo o Futuro</span>
          </h2>
          <p>
            Profissionais das maiores empresas globais e pesquisadores renomados reunidos na FACOM / UFU.
          </p>
        </div>
